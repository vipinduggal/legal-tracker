...
# Write a standalone post-processing script that:
# 1. Reads AMD's current data
# 2. Deduplicates contacts
# 3. Runs live intelligence fresh
# 4. Saves everything correctly
# This bypasses the researcher.js pipeline entirely for testing

script_path = os.path.join(base, "scripts", "fixAMD.js")

script = '''// scripts/fixAMD.js
...
print("Done — scripts/fixAMD.js written")
print("")
print("Run: node scripts/fixAMD.js")
print("")
print("This runs dedup + live intel + save in one clean sequence")
print("Watch the output for trigger counts")
