...
path = os.path.join(base, "src", "jobs", "filingsMonitor.js")

content = '''// filingsMonitor.js — Real-time filing monitor
...
print("Done — filingsMonitor.js rewritten with real sources")
print("")
print("Sources now used:")
print("  SEC EDGAR    — 8-K filings for 30 public company accounts")
print("  CourtListener — All federal court filings for all 33 accounts")
print("  FTC RSS feed  — FTC enforcement actions")
print("  DOJ RSS feed  — DOJ press releases and actions")
print("  CFPB RSS feed — CFPB enforcement actions")
print("")
print("Test it now:")
print("  cd ~/legal-tracker && node src/jobs/filingsMonitor.js")
print("")
print("Then restart:")
