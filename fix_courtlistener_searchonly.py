...
path = os.path.join(home, "legal-tracker", "src", "jobs", "courtListenerMonitor.js")

# High value NOS codes for eDiscovery
HIGH_VALUE_NOS = {
    "410": "Antitrust",
    "850": "Securities Class Action",
    "830": "Patent",
    "820": "Copyright",
    "190": "Contract Dispute",
    "191": "Contract: Medicare",
    "192": "Contract: Marine",
    "193": "Contract: Miller Act",
    "195": "Contract: Products Liability",
    "440": "Civil Rights",
...
const HIGH_VALUE_NOS = ''' + str(HIGH_VALUE_NOS) + ''';
...
print("Done — courtListenerMonitor.js fully rewritten")
print("Uses search results only — no rate-limited detail calls")
print("")
print("Test: npm run court:account microsoft")
print("Should show Bryant v. Microsoft (Antitrust) and Bird v. Microsoft (Copyright)")
print("with Dechert LLP, Susman Godfrey as counsel")
