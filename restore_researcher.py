...
# Write a completely fresh researcher.js with split calls built in cleanly
path = os.path.join(base, "src", "researcher.js")
...
print("Done — researcher.js fully restored")
